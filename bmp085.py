...
print
print "Temperature:", t/10.0*1.8+32, "F"
print "Pressure:    %.2f" % (p / 3386.389), "inHG"
t = t / 10.0 * 1.8 + 32
p = p / 3386.389
t = "%.2f" % t
p = "%.2f" % p
...
with db:
	logit = "INSERT into readings (time,temperature,pressure) values (%s,%s,%s)"
	cursor.execute(logit,(times,t,p))
	db.commit()
	print "Data Commited"
